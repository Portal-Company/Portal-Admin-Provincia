  ...
  return (
    <Fragment>
      <Accordion as="ul" className="navbar-nav iq-main-menu" id="sidebar-menu">
          ...
          <Accordion.Collapse eventKey="area-provincia">
            <ul className="sub-nav">
              <Nav.Item as="li">
                <Link
                  className={`${
                    location.pathname === "/category/category/add"
                      ? "active"
                      : ""
                  } nav-link`}
              ...
              <Nav.Item as="li">
                <Link
                  className={`${
                    location.pathname === "/category/category/list"
                      ? "active"
                      : ""
                  } nav-link`}
        ...
        <Accordion.Item
          as="li"
          eventKey="area-disciplina2"
          bsPrefix={`nav-item ${active === "pulgins" ? "active" : ""} `}
          onClick={() => setActive("pulgins")}
        >
          <CustomToggle
            eventKey="area-provincia2"
            active={activeMenu === "plugins" ? true : false}
            onClick={(activeKey) => setActiveMenu(activeKey)}
          >
            <OverlayTrigger
            ...
            <span className="item-name">Administradores</span>
            <i className="right-icon">
              <svg
                className="icon-18"
                xmlns="http://www.w3.org/2000/svg"
          ...
          <Accordion.Collapse eventKey="area-provincia2">
            <ul className="sub-nav">
              <Nav.Item as="li">
                <Link
                  className={`${
                    location.pathname === "/user/user-add" ? "active" : ""
                  } nav-link`}
                  to="/user/user-add"
                >
                  <i className="icon">
                  ...
                  <OverlayTrigger
                    placement="right"
                    overlay={<Tooltip>Adicionar Usuario</Tooltip>}
                  >
                    <i className="sidenav-mini-icon"> A </i>
                  </OverlayTrigger>
              ...
              <Nav.Item as="li">
                <Link
                  className={`${
                    location.pathname === "/user/user-list" ? "active" : ""
                  } nav-link`}
                  to="/user/user-list"
                >
                  <i className="icon">
                  ...
                  <OverlayTrigger
                    placement="right"
                    overlay={<Tooltip>Listar Usuario</Tooltip>}
                  >
                    <i className="sidenav-mini-icon"> U </i>
                  </OverlayTrigger>
                  <span className="item-name">Listar Usuario</span>
                </Link>
              </Nav.Item>
            </ul>
          </Accordion.Collapse>
