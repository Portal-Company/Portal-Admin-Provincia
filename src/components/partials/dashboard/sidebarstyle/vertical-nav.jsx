      ...
      <Accordion as="ul" className="navbar-nav iq-main-menu" id="sidebar-menu">
        ...
        >
          ...
          >
            ...
            <span className="item-name">Area de Usuarios</span>
            <i className="right-icon">
              <svg
                className="icon-18"
                xmlns="http://www.w3.org/2000/svg"
          ...
          <Accordion.Collapse eventKey="area-usuario">
            <ul className="sub-nav">
              <Nav.Item as="li">
                <Link
                  className={`${
                ...
                >
                  ...
                  <span className="item-name">Adicionar Usuário</span>
                </Link>
              </Nav.Item>
              <Nav.Item as="li">
                <Link
              ...
              <Nav.Item as="li">
                ...
                >
                  ...
                  <span className="item-name">Listar Usuario Desabilitado</span>
                </Link>
              </Nav.Item>
              <Nav.Item as="li">
                <Link
                ...
                >
                  ...
                  <span className="item-name">Desabilitar Usuário</span>
                </Link>
              </Nav.Item>
            </ul>
          </Accordion.Collapse>
